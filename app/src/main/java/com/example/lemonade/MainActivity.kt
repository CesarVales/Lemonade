...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        //var text = findViewById<TextView>(R.id.text_action)
        when (lemonadeState) {
            SELECT -> {
    ...
    private fun setViewElements() {
        ...
        val drawableLemonTree = when(lemonadeState) {
        ...
        lemonImage?.setImageResource(drawableLemonTree)
        textAction.text =
        when(lemonadeState) {
            SELECT -> "Click to pick the lemon"
            SQUEEZE ->  "Click To Squeeze the lemmon \nor hold to Check how many squeezes"
            DRINK -> "Click to Drink"
            else -> {"Click again to make another lemonade :) "}
        }
